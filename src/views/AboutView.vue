    ...
    <div class="font-sairaBody px-2 pt-10 text-lg text-red-light sm:text-3xl">
      <div>
        <div class="text-center">
          ...
          recommendation website <br />
          made by me, <span class="text-white-light">Aditya Singh</span>.
          <br /><br />
          I will be updating the website UI and bring in more features such as
        </div>
        <ul
          class="flex list-inside list-disc flex-col items-center justify-center py-5 sm:list-outside"
        >
